...
<div class="bg-[#18202E] rounded-lg shadow my-8 mx-2 xl:mx-72">
        ...
        <div class="md:grid md:grid-cols-2 md:gap-16">
            <div>
                ...
                <div class="md:grid md:grid-cols-2 gap-4">
                    <div class="text-center">
                        <img class="mx-auto" height="70%" width="70%" src='<?= $user->get2Fa()->getQrCode(250) ?>'
                    ...
                    <form
                        ...
                        <div class="text-center mt-2">
                            <button type="submit" class="bg-blue-900 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center"><?= $user->get2Fa()->isEnabled() ? 'Désactiver' : 'Activer' ?></button>
                        </div>
                    </form>
                </div>
            ...
            <div>
                <div class="mb-4">
                    ...
                    <img class="mx-auto rounded-lg border border-gray-600 shadow-xl" src="<?= $user->getUserPicture()->getImage() ?>" height="50%" width="50%" alt="Image de profil de <?/*= $user->getUsername()*/ ?>">
                    <?php endif; ?>
                </div>
                <div>
    ...
    <div class="pt-2 pb-6 text-center">
        ...
        <a href="<?= EnvManager::getInstance()->getValue("PATH_SUBFOLDER") ?>account/delete/<?= $user->getId() ?>" class="mb-4 bg-red-700 hover:bg-red-800 font-medium rounded-lg text-sm px-5 py-2.5 text-center">Supprimer mon compte</a>
    </div>
