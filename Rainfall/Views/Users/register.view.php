...
$description = 'Inscrivez-vous sur ' . Website::getName(); ?>
        ...
        <div class="py-6 px-6 lg:px-8">
            <form class="space-y-6" action="" method="post">
                ...
                <div>
                    ...
                    <input name="register_email" type="email" class="bg-gray-800 border border-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5" placeholder="<?php LangManager::translate("users.users.mail")?>" required>
                </div>
                <div>
                    <label for="email" class="block mb-2 text-sm font-medium">Pseudo / Nom d'affichage</label>
                    <input name="register_pseudo" type="text" class="bg-gray-800 border border-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5" placeholder="<?php LangManager::translate("users.users.pseudo") ?>" required>
                </div>
                <div>
                    <label for="password" class="block mb-2 text-sm font-medium">Mot de passe</label>
                    <div class="flex">
                        <input id="passwordInput" type="password" name="register_password" placeholder="<?php LangManager::translate("users.users.pass") ?>" class="block bg-gray-800 border border-gray-900 text-sm rounded-l-lg block w-full p-2.5" required>
                ...
                <div>
                    ...
                    <div class="flex">
                        <input id="passwordInputV" type="password" name="register_password_verify" placeholder="<?php LangManager::translate("users.users.pass") ?>" class="block bg-gray-800 border border-gray-900 text-sm rounded-l-lg block w-full p-2.5" required>
                ...
                <button type="submit" class="w-full bg-blue-900 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center"><?php LangManager::translate("users.login.register")?></button>
            </form>
