...
<section class="px-4 lg:px-16 py-6">
    <div class="lg:grid lg:grid-cols-5 gap-6 ">
        ...
        <div class="my-8 mx-2  bg-blue-200 xl:mx-72 col-span-4">
            <div class="p-4">
                <div class="md:grid md:grid-cols-5 md:gap-16">
                    <div>
                        <img class="mx-auto rounded-lg border border-gray-300 shadow-xl"
                             src="https://dev2.craftmywebsite.fr/Public/Uploads/News/JMqi4DwgRUevaAKH1bkxnCGBVtSOX.png"
                             height="90%" width="90%" alt="...">
                        <div class="text-center mt-2">
                            Auteur : Moi
                        </div>
                        <div class="text-center mt-2">
                            <div class="bg-gray-300 text-gray-900 font-medium inline-block px-3 py-1 rounded-sm text-xs ">
                                Date
                            </div>
                        </div>
                        <div class="text-center mt-2">
            ...
            <div class="pt-2 pb-6 px-2 lg:px-24 2xl:px-72">
                ...
                <div style="background-color: #18202E !important;"
                    ...
                    <div class="">
                        <img class="hidden lg:block mx-auto rounded-lg border border-gray-300 shadow-xl"
                             src="https://dev2.craftmywebsite.fr/Public/Uploads/Users/Default/defaultImage.jpg"
                ...
                <form method="post" action="" class="">
                    <label for="message" class="block mb-2 text-sm font-medium text-white dark:text-gray-400">Votre
                        commentaire :</label>
                    <textarea id="message" rows="4" style="background-color: #18202E !important;"
                    ...
                    <div class="text-center mt-4">
                        ...
                        <button type="button"
                                class="text-white bg-blue-400 cursor-not-allowed font-medium rounded-lg px-4 py-2 md:px-5 md:py-2.5 mr-1 md:mr-2 text-center"
                                disabled="">Connectez vous
                        </button>
