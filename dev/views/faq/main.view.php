<div style="background-color: #18202E !important;" class="w-full pt-14 pb-4">
    <div class="text-center pt-4 font-bold text-4xl border-t border-gray-500">FAQ</div>
</div>
                ...
                <div class="flex flex-wrap -mx-4 mb-4">
                    <div class="px-4 w-full md:w-6/12 lg:w-6/12">
                        ...
                        <div class="relative">
                            ...
                            <input type="text" id="email-address-icon" class="bg-gray-800 border border-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full pl-10 p-2.5" placeholder="votre@mail.com">
                        </div>
                    </div>
                    <div class="px-4 w-full md:w-6/12 lg:w-6/12">
                        ...
                        <div class="relative">
                            ...
                            <input type="text" id="email-address-icon" class="bg-gray-800 border border-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full pl-10 p-2.5" placeholder="Jean Dupont">
                        </div>
                    </div>
                </div>
                <div class="mb-2">
                    ...
                    <div class="relative">
                        ...
                        <input type="text" id="email-address-icon" class="bg-gray-800 border border-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full pl-10 p-2.5" placeholder="J'aimerais aborder avec vous ...">
                    </div>
                </div>
                <div class="mb-2">
                    <label for="message" class="block mb-2 text-sm font-medium">Votre message :</label>
                    <textarea id="message" rows="4" class="block p-2.5 w-full text-sm bg-gray-800 border border-gray-900 rounded-lg focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Bonjour,"></textarea>
                </div>
