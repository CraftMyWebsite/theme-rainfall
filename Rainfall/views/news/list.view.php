...
$newsLists = $newsModel->getSomeNews(ThemeModel::fetchConfigValue('news_page_number_display'), 'DESC');
...
<div style="background-color: #18202E !important;" class="w-full pt-14 pb-4">
    <div class="text-center pt-4 font-bold text-4xl border-t border-gray-500"><?= ThemeModel::fetchConfigValue('news_page_title') ?></div>
</div>
