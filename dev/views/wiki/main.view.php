...
<section class="px-4 lg:px-16 py-6">
    <div class="lg:grid lg:grid-cols-5 gap-6">
        ...
        <section class="grid lg:grid-cols-3 gap-4 rounded-lg my-8 mx-2 lg:mx-72 col-span-4">
            ...
            <div style="background-color: #18202E !important;" class="container mx-auto rounded-md shadow-lg p-4 h-fit">
                ...
                <div class="font-medium text-gray-500 mt-6 cursor-default">Titre de catégorie</div>
                <a href="#">
                    <div class="pl-2 py-1 mt-1 cursor-pointer rounded hover:bg-gray-900">Titre d'article</div>
                </a>
            </div>

            <div class="col-span-2 mt-4 lg:mt-0">
                <div style="background-color: #18202E !important;"
                     class="container mx-auto rounded-md shadow-lg py-4 px-8 h-fit">
                    <div class="flex flex-no-wrap justify-center items-center py-4">
                        <div class="px-10 w-auto">
                            <h2 class="font-semibold text-2xl uppercase">Titre de l'article</h2>
                        </div>
                    </div>
                    <div class="flex flex-wrap justify-between border-t">
                        <div class="mt-1">Crée le :</div>
                        <div style="background-color: #1e293b !important;"
                             class="font-medium inline-block px-3 py-1 rounded-sm text-xs mt-1">Zomb
                        </div>
                        <div class="mt-1">Modifié le :</div>
                    </div>
                </div>
            </div>
        </section>
