...
<div class="bg-[#18202E] w-full pt-14 pb-4">
    <div class="text-center pt-4 font-extrabold text-4xl border-t border-gray-500"><?= ucfirst($page->getTitle())?></div>
</div>
...
<section class="bg-[#18202E] rounded-lg shadow my-8 mx-2 lg:mx-72">
