...
<div class="bg-[#18202E] rounded-lg shadow my-8 mx-2 xl:mx-72">
        ...
        <div class="md:grid md:grid-cols-2 md:gap-16">
            ...
            <div>
                <div class="mb-4">
                    ...
                    <img class="mx-auto rounded-lg border border-gray-600 shadow-xl" src="https://dev.voyza.fr/public/uploads/users/default/defaultImage.jpg" height="50%" width="50%" alt="Image de profil de <?/*= $user->getUsername()*/ ?>">
                    <?php /*endif;*/ ?>
                </div>
    ...
    <div class="pt-2 pb-6 text-center">
        ...
        <a href="" class="mb-4 bg-red-700 hover:bg-red-800 font-medium rounded-lg text-sm px-5 py-2.5 text-center">Supprimer mon compte</a>
    </div>
