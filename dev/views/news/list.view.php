...
<section class="px-4 lg:px-16 py-6">
    ...
    <div class="lg:grid lg:grid-cols-2 col-span-4 gap-6 mt-4 lg:mt-0 h-fit">
        <div style="background-color: #18202E !important;" class="mb-4 lg:mb-0 flex flex-wrap h-full overflow-hidden rounded-md shadow-lg">
            <div class="w-full md:w-5/12 lg:w-full xl:w-5/12">
                <div class="h-full relative">
                    ...
                    <div class="absolute bg-blue-600 font-semibold leading-tight left-0 ml-3 mt-3 px-3 py-2 text-center top-0">
                        <div class="text-sm">Zomb</div>
                    </div>
                </div>
            </div>
            <div class="px-8 py-6 w-full md:w-7/12 lg:w-full xl:w-7/12">
                <div class="mb-3">
                    <div class="bg-gray-300 font-medium inline-block px-3 py-1 rounded-sm text-xs uppercase">26/10/2022 à 13:11:22</div>
                </div>
