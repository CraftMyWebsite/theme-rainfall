...
<section class="px-4 lg:px-16 py-6">
    <?php if (ThemeModel::getInstance()->fetchConfigValue('widget','widget_use_news')): ?>
    <div class="lg:grid lg:grid-cols-5 gap-6">
        ...
        <?php endif; ?>
        <div
            class=" mx-2 <?php if (!ThemeModel::getInstance()->fetchConfigValue('widget','widget_use_news')): ?>lg:mx-72<?php endif; ?> col-span-4">
            <div class="container">
        ...
        <?php if (ThemeModel::getInstance()->fetchConfigValue('widget','widget_use_news')): ?></div><?php endif; ?>
</section>
