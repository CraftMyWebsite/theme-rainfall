...
<section class="px-4 lg:px-16 py-6">
    ...
    <?php if (ThemeModel::fetchConfigValue('widget_use_news_list')): ?>
    <div class="lg:grid lg:grid-cols-5 gap-6">
        ...
        <div class="lg:grid lg:grid-cols-2 col-span-4 <?php if (!ThemeModel::fetchConfigValue('widget_use_news_list')): ?>lg:mx-72<?php endif; ?> gap-6 mt-4 lg:mt-0 h-fit">
        ...
        <?php if (ThemeModel::fetchConfigValue('widget_use_news_list')): ?></div><?php endif; ?>
