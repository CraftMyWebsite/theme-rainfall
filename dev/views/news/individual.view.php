<div style="background-color: #18202E !important;" class="w-full pt-14 pb-4">
    <div class="text-center pt-4 font-bold text-4xl border-t border-gray-500">Actualités</div>
</div>
...
<div class="my-8 mx-2 xl:mx-72 col-span-4">
<div class="p-4">
        <div class="md:grid md:grid-cols-5 md:gap-16">
            <div>
                ...
                <div class="text-center mt-2">
                    <div class="bg-gray-300 text-gray-900 font-medium inline-block px-3 py-1 rounded-sm text-xs ">Date</div>
                </div>
                <div class="text-center mt-2">
    ...
    <div class="pt-2 pb-6 px-2 lg:px-24 2xl:px-72">
        ...
        <form method="post" action="" class="">
            ...
            <textarea id="message" rows="4" style="background-color: #18202E !important;" class="block p-2.5 w-full text-sm text-gray-900 rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500 " placeholder="Bonjour,"></textarea>
            <div class="text-center mt-4">
                ...
                <button type="button" class="text-white bg-blue-400 cursor-not-allowed font-medium rounded-lg px-4 py-2 md:px-5 md:py-2.5 mr-1 md:mr-2 text-center" disabled="">Connectez vous</button>
