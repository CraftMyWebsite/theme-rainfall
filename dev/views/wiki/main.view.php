...
<section class="px-4 lg:px-16 py-6">
    ...
    <div class="lg:grid lg:grid-cols-5 lg:grid-cols-4 gap-6">
        ...
        <div class="col-span-3 mt-4 lg:mt-0">
            <div style="background-color: #18202E !important;" class="container mx-auto rounded-md shadow-lg py-4 px-8 h-fit">
                ...
                <div class="flex flex-wrap justify-between border-t">
                    ...
                    <div style="background-color: #1e293b !important;" class="font-medium inline-block px-3 py-1 rounded-sm text-xs mt-1">Zomb</div>
