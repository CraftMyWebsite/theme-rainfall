    ...
    <div class="p-4">
        <div class="md:grid md:grid-cols-5 md:gap-16">
            <div>
                ...
                <div class="text-center mt-2">
                    <div class="bg-gray-300 text-gray-900 font-medium inline-block px-3 py-1 rounded-sm text-xs"><?= $news->getDateCreated() ?></div>
                </div>
                <div class="text-center mt-2">
...
<?php foreach ($news->getComments() as $comment): ?>
        <div style="background-color: #18202E !important;" class="rounded-lg shadow md:grid md:grid-cols-5 py-4 pr-4 mb-4">
            <div class="">
            ...
            <div class="col-span-4 px-4 md:px-0">
                ...
                <div class="flex justify-between">
                    ...
                    <div class="bg-gray-300 text-gray-900 font-medium inline-block px-3 py-1 rounded-sm text-xs uppercase"><?= $comment->getDate() ?></div>
                </div>
...
<?php endforeach; ?>   
        <form method="post" action="<?= $news->sendComments() ?>" class="">
            ...
            <textarea name="comments" id="message" rows="4" style="background-color: #18202E !important;" class="block p-2.5 w-full text-sm rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500 " placeholder="Bonjour," required></textarea>
            <div class="text-center mt-4">
                <?php if(UsersController::isUserLogged()): ?>
                <button type="submit" class="text-white bg-blue-900 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg px-4 py-2 md:px-5 md:py-2.5 mr-1 md:mr-2 focus:outline-none">Commenter <i class="fa-solid fa-comments"></i></i></button>
                <?php else: ?> 
                <a href="/login" class="text-white bg-blue-900 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg px-4 py-2 md:px-5 md:py-2.5 mr-1 md:mr-2 focus:outline-none">Commenter <i class="fa-solid fa-comments"></i></i></a>
                <?php endif; ?>
            </div>
        </form>
    </div>
