...
<div class="bg-[#18202E] w-full pt-14 pb-4">
    <div class="text-center pt-4 font-extrabold text-4xl border-t border-gray-500">Mot de passe oublié</div>
</div>
    ...
    <div class="relative bg-[#18202E] rounded-lg shadow">
        <div class="py-6 px-6 lg:px-8">
            ...
            <div class="flex flex-wrap justify-between">
                <div class=" text-sm mt-4"><a href="register" class="text-blue-500">S'enregistrer</a></div>
                <div class=" text-sm mt-4"><a href="register" class="text-blue-500">Se connecter</a></div>
            </div>
