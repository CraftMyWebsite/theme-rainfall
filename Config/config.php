                ...
                <div class="card-in-card">
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="form-check form-switch mt-4">
                                <div>
                                    <input class="form-check-input" type="checkbox" value="1" id="widget_use_page" name="widget_use_page" <?= ThemeModel::fetchConfigValue('widget_use_page') ? 'checked' : '' ?>>
                                    <label class="form-check-label" for="widget_use_page"><h6>Pages</h6></label>
                                </div>
                                <div>
                                    <input class="form-check-input" type="checkbox" value="1" id="widget_use_cgu" name="widget_use_cgu" <?= ThemeModel::fetchConfigValue('widget_use_cgu') ? 'checked' : '' ?>>
                                    <label class="form-check-label" for="widget_use_cgu"><h6>CGU</h6></label>
                                </div>
                                <div>
                                    <input class="form-check-input" type="checkbox" value="1" id="widget_use_cgv" name="widget_use_cgv" <?= ThemeModel::fetchConfigValue('widget_use_cgv') ? 'checked' : '' ?>>
                                    <label class="form-check-label" for="widget_use_cgv"><h6>CGV</h6></label>
                                </div>
                                <?php if (PackageController::isInstalled("News")): ?>
                                <div>
                                    <input class="form-check-input" type="checkbox" value="1" id="widget_use_news_list" name="widget_use_news_list" <?= ThemeModel::fetchConfigValue('widget_use_news_list') ? 'checked' : '' ?>>
                                    <label class="form-check-label" for="widget_use_news_list"><h6>Liste des news</h6></label>
                                </div>
                                <?php endif; ?>
                                <?php if (PackageController::isInstalled("News")): ?>
                                <div>
                                    <input class="form-check-input" type="checkbox" value="1" id="widget_use_news" name="widget_use_news" <?= ThemeModel::fetchConfigValue('widget_use_news') ? 'checked' : '' ?>>
                                    <label class="form-check-label" for="widget_use_news"><h6>News</h6></label>
                                </div>
                                <?php endif; ?>
                                <?php if (PackageController::isInstalled("Votes")): ?>
                                <div>
                                    <input class="form-check-input" type="checkbox" value="1" id="widget_use_vote" name="widget_use_vote" <?= ThemeModel::fetchConfigValue('widget_use_vote') ? 'checked' : '' ?>>
                                    <label class="form-check-label" for="widget_use_vote"><h6>Votes</h6></label>
                                </div>
                                <?php endif; ?>
                                <?php if (PackageController::isInstalled("Wiki")): ?>
                                <div>
                                    <input class="form-check-input" type="checkbox" value="1" id="widget_use_wiki" name="widget_use_wiki" <?= ThemeModel::fetchConfigValue('widget_use_wiki') ? 'checked' : '' ?>>
                        ...
                        <div class="form-check form-switch">
                            ...
                            <div class="">
                                <div class="card me-2 p-3">
                                    <div class="form-check form-switch">
                                        <input class="form-check-input" type="checkbox" value="1" id="widgets_show_discord" name="widgets_show_discord" <?= ThemeModel::fetchConfigValue('widgets_show_discord') ? 'checked' : '' ?>>
                                        <label class="form-check-label" for="widgets_show_discord"><h6>Discord</h6></label>
                                    </div>
                                    <h6>Id Discord :</h6>
                                    <input type="text" class="form-control" id="widgets_content_id" name="widgets_content_id" value="<?= ThemeModel::fetchConfigValue('widgets_content_id') ?>" required>
                                </div>
                            </div>
                            <div class="">
                                <div class="card me-2 p-3">
                                    <div class="form-check form-switch">
                                        <input class="form-check-input" type="checkbox" value="1" id="widgets_show_custom_1" name="widgets_show_custom_1" <?= ThemeModel::fetchConfigValue('widgets_show_custom_1') ? 'checked' : '' ?>>
                                        <label class="form-check-label" for="widgets_show_custom_1"><h6>Widget personnalisé 1</h6></label>
                                    </div>
                                    <h6>Titre du widget :</h6>
                                    <input type="text" class="form-control" id="widgets_custom_title_1" name="widgets_custom_title_1" value="<?= ThemeModel::fetchConfigValue('widgets_custom_title_1') ?>" required>
                                    <h6>Contenu :</h6>
                                    <textarea name="widgets_custom_text_1" class="tinymce"><?= ThemeModel::fetchConfigValue('widgets_custom_text_1') ?></textarea>
                                </div>
                            </div>
                        <div class="">
                            <div class="card me-2 p-3">
                                <div class="form-check form-switch">
                                    <input class="form-check-input" type="checkbox" value="1" id="widgets_show_custom_2" name="widgets_show_custom_2" <?= ThemeModel::fetchConfigValue('widgets_show_custom_2') ? 'checked' : '' ?>>
                                    <label class="form-check-label" for="widgets_show_custom_1"><h6>Widget personnalisé 2</h6></label>
                                </div>
                                <h6>Titre du widget :</h6>
                                <input type="text" class="form-control" id="widgets_custom_title_2" name="widgets_custom_title_2" value="<?= ThemeModel::fetchConfigValue('widgets_custom_title_2') ?>" required>
                                <h6>Contenu :</h6>
                                <textarea name="widgets_custom_text_2" class="tinymce"><?= ThemeModel::fetchConfigValue('widgets_custom_text_2') ?></textarea>
                            </div>
                        </div>
