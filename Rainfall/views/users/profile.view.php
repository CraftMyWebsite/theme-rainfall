...
<div style="background-color: <?= ThemeModel::fetchConfigValue('secondaryColor') ?> !important;" class="w-full pt-14 pb-4">
    <div class="text-center pt-4 font-bold text-4xl border-t border-gray-500">Votre profil</div>
</div>
...
<div style="background-color: <?= ThemeModel::fetchConfigValue('secondaryColor') ?> !important;" class="rounded-lg shadow my-8 mx-2 xl:mx-72">
        ...
        <div class="md:grid md:grid-cols-2 md:gap-16">
            ...
            <div>
                ...
                <form class="space-y-6" action="profile/update" method="post">
                    ...
                    <div>
                        ...
                        <input type="text" name="pseudo" id="pseudo" class="bg-gray-800 border border-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5" value="<?= $user->getUsername() ?>" required>
                    </div>
                    <div>
            ...
            <div>
                <div class="mb-4">
                    ...
                    <img class="mx-auto rounded-lg border border-gray-600 shadow-xl" src="<?= getenv('PATH_SUBFOLDER') ?>public/uploads/users/<?= $user->getUserPicture()->getImageName() ?>" height="50%" width="50%" alt="Image de profil de <?= $user->getUsername() ?>">
                    <?php endif; ?>
                </div>
    ...
    <div class="pt-2 pb-6 text-center">
        ...
        <a href="<?= getenv('PATH_SUBFOLDER') ?>profile/delete/<?= $user->getId() ?>" class="mb-4 bg-red-700 hover:bg-red-800 font-medium rounded-lg text-sm px-5 py-2.5 text-center">Supprimer mon compte</a>
    </div>
