...
<div class="bg-[#18202E] w-full pt-14 pb-4">
    <div class="text-center pt-4 font-extrabold text-4xl border-t border-gray-500" data-cmw="faq:faq_page_title"></div>
</div>
...
<section class="px-2 md:px-24 xl:px-48 2xl:px-72 py-6">
    <div class="<?php if(ThemeModel::getInstance()->fetchConfigValue('faq','faq_display_form')): {echo "lg:grid lg:grid-cols-3 gap-6";} endif ?>">
        <div data-cmw-visible="faq:faq_display_form" style="background-color: #18202E !important;" class="container mx-auto rounded-md shadow-lg p-8">
            ...
            <div style="background-color: #18202E !important;" class="container mx-auto rounded-md shadow-lg p-8">
                ...
                <div class="border-b py-2">
                    <div class="flex flex-wrap justify-between">
                        ...
                        <div data-cmw-visible="faq:faq_display_autor" class="bg-gray-500 font-medium inline-block px-3 py-1 rounded-sm text-xs uppercase"><?= $faq->getAuthor()->getPseudo() ?></div>
                    </div>
